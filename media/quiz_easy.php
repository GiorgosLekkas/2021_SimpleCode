...
<html>
    ...
    <body>
        ...
        <article class="board">
            ...
            <form class="truefalse" name="quiz_easy" method="post" action="php/results.php" id="quiz_easy" >
                <ul class="list1">
                    <?php
                        ...
                        $sql = "SELECT * FROM tf_easy ORDER BY rand()";
                ...
                <ul class="list2">
                    <?php
                        ...
                        $sql = "SELECT * FROM mc_easy ORDER BY rand()";
                        $result = mysqli_query($con,$sql);
                    ?>
                    <?php if($row = $result->fetch_assoc()){ ?>
                    <li>
                    ...
                    <li>
                      ...
                      <input type="hidden" id="res" name='level' value='easy' >
